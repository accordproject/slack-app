...
This document describes how to set up your development environment to build and test AP-Slack-App, and
explains the basic mechanics of using `git`, `node`, `npm`.

### Installing Dependencies

Before you can build AP-Slack-App, you must install and configure the following dependencies on your
machine:
...
But also, we use the git commit messages to **generate the AP-Slack-App change log**.
...
version-specific documentation by simply checking out a version of AP-Slack-App and running the build.
